<article role="article">
    ...
    <div id="case">
      <section id="head-<?php echo $post->post_name; ?>" class="section case head <?php echo $post->post_name; ?>" data-bs="<?php the_field('case_head'); ?>">
      ...
      <section id="info-<?php echo $post->post_name; ?>" class="section case info <?php echo $post->post_name; ?>" data-bs="<?php the_field('case_info'); ?>">
